...
use cstwitter\core\Infra;
use cstwitter\utils\Utils;
use cstwitter\platform\Platform;
...
class Entry{
	...
	$__scripts__ = 'dist/js/chunk-2d0ae5a4.2c5a6eb7.js,dist/js/chunk-common.809f735d.js,dist/js/chunk-vendors.3c9f5678.js,dist/js/index.748ab0cf.js';
	...
	function parseShortcode( $atts ){
		...
		$app['value']['lists'] = \cstwitter\utils\fillDynamicSources(
			$app['value']['lists'], 
			$atts
		);
	...
	function printOutput(){
		...
		include_once(__DIR__.'/utils/output.php');
		echo \cstwitter\utils\printOutput(
			$this->outputs,
